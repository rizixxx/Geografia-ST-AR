...
public class PlanetGame : MonoBehaviour
{
    PlanetsOrbit script1;
    ...
    private void planetsOrbit_enable(string tag)
    {
        script1 = GameObject.FindGameObjectWithTag(tag).GetComponent<PlanetsOrbit>();
